...
import { MotionHighlight, MotionHighlightItem } from '@shared/components/effects/motion-highlight'
...
function TabsList({
  ...
  return (
    <MotionHighlight
      ...
      className={cn('bg-primary rounded-sm', activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <div
